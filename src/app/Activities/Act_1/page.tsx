                  ...
                  <div key={todo.id} className={styles.friendCard}>
                    ...
                    >
                      {todo.is_complete ? (
                        ...
                        >
                          <path
                            d="M12 12H12.01M12 6V6.01M12 18V18.01M18 12H18.01M6 12H6.01M18.364 5.636L18.364 5.636M18.364 18.364L18.364 18.364M5.636 18.364L5.636 18.364M5.636 5.636L5.636 5.636"
                            stroke="currentColor"
                            strokeWidth="2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
